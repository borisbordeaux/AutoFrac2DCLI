...
public:
    explicit StructurePrinter(frac::Structure const& structure, bool planarControlPoints, std::string filename, unsigned int nbIterAutoSubs, std::string libPath, std::vector<std::vector<Point2D>> const& coords = {});
    void exportStruct();
private:
    void print_header();
